...
def plot_boxplot(df: pd.DataFrame, query_type: str, out_prefix: pathlib.Path) -> plt.Figure:
...
def plot_ratio(df: pd.DataFrame, query_type: str, out_prefix: pathlib.Path) -> plt.Figure:
    fig, ax = plt.subplots(1, 1)
